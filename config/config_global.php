...
// ----------------------------  CONFIG DB  ----------------------------- //
$_config['db']['1']['dbhost'] = 'mysql.createclouds.cn:6033';
$_config['db']['1']['dbuser'] = 'root';
$_config['db']['1']['dbpw'] = 'NDMzNTJiOTAyOWVhOWE2NmE5MzQ1YzA5';
...
// --------------------------  CONFIG COOKIE  --------------------------- //
$_config['cookie']['cookiepre'] = 'fq0l_';
$_config['cookie']['cookiedomain'] = '';
$_config['cookie']['cookiepath'] = '/';

// -------------------------  CONFIG SECURITY  -------------------------- //
$_config['security']['authkey'] = '924197Hv3G6Mt9kp';
